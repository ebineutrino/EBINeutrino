...
public class EBIDataControlCampaign {
                ...
                EBISystem.gui().table("companyCampaignTable", "Campaign").
                        changeSelection(EBISystem.gui().table("companyCampaignTable", "Campaign").
                                convertRowIndexToView(EBISystem.getCRMModule().dynMethod.
                                        getIdIndexFormArrayInATable(EBISystem.getCRMModule().getEBICRMCampaign().tabModelCampaign.data, 4, ncamp.getCampaignid())), 0, false, false);
            }
        ...
        try {
            ...
            if (iter.hasNext()) {
                ...
                EBISystem.gui().table("companyCampaignTable", "Campaign").
                        changeSelection(EBISystem.gui().table("companyCampaignTable", "Campaign").
                                convertRowIndexToView(EBISystem.getCRMModule().dynMethod.
                                        getIdIndexFormArrayInATable(EBISystem.getCRMModule().getEBICRMCampaign().tabModelCampaign.data, 4, id)), 0, false, false);
    ...
    public void dataShow() {
        ...
        try {
            ...
            if (set != null) {
                set.last();
                EBISystem.getCRMModule().getEBICRMCampaign().tabModelCampaign.data = new Object[set.getRow()][5];

                if (set.getRow() > 0) {
                    set.beforeFirst();
                    int i = 0;
                    while (set.next()) {
                        EBISystem.getCRMModule().getEBICRMCampaign().tabModelCampaign.data[i][0] = set.getString("NAME") == null ? "" : set.getString("NAME");
                        EBISystem.getCRMModule().getEBICRMCampaign().tabModelCampaign.data[i][1] = set.getString("STATUS") == null ? "" : set.getString("STATUS");
                        EBISystem.getCRMModule().getEBICRMCampaign().tabModelCampaign.data[i][2] = set.getDate("VALIDFROM") == null ? "" : EBISystem.getInstance().getDateToString(set.getDate("VALIDFROM"));
                        EBISystem.getCRMModule().getEBICRMCampaign().tabModelCampaign.data[i][3] = set.getDate("VALIDTO") == null ? "" : EBISystem.getInstance().getDateToString(set.getDate("VALIDTO"));
                        EBISystem.getCRMModule().getEBICRMCampaign().tabModelCampaign.data[i][4] = set.getInt("CAMPAIGNID");
                        i++;
                    }
                }else {
                    EBISystem.getCRMModule().getEBICRMCampaign().tabModelCampaign.data = new Object[][]{{EBISystem.i18n("EBI_LANG_PLEASE_SELECT"), "", "", "",""}};
                }
            }
            EBISystem.getCRMModule().getEBICRMCampaign().tabModelCampaign.fireTableDataChanged();
    ...
    public void dataShowReciever() {
        ...
        if (this.campaign.getCrmcampaignreceivers().size() > 0) {
            EBISystem.getCRMModule().getEBICRMCampaign().tabModReceiver.data = new Object[this.campaign.getCrmcampaignreceivers().size()][14];
            ...
            while (itr.hasNext()) {
                ...
                EBISystem.getCRMModule().getEBICRMCampaign().tabModReceiver.data[i][0] = obj.getReceivervia() == null ? "" : obj.getReceivervia();
                EBISystem.getCRMModule().getEBICRMCampaign().tabModReceiver.data[i][1] = obj.getCompanynumber() == null ? "" : obj.getCompanynumber();
                EBISystem.getCRMModule().getEBICRMCampaign().tabModReceiver.data[i][2] = obj.getCompanyname() == null ? "" : obj.getCompanyname();
                EBISystem.getCRMModule().getEBICRMCampaign().tabModReceiver.data[i][3] = obj.getGender() == null ? "" : obj.getGender();
                EBISystem.getCRMModule().getEBICRMCampaign().tabModReceiver.data[i][4] = obj.getSurname() == null ? "" : obj.getSurname();
                EBISystem.getCRMModule().getEBICRMCampaign().tabModReceiver.data[i][5] = obj.getName() == null ? "" : obj.getName();
                EBISystem.getCRMModule().getEBICRMCampaign().tabModReceiver.data[i][6] = obj.getPosition() == null ? "" : obj.getPosition();
                EBISystem.getCRMModule().getEBICRMCampaign().tabModReceiver.data[i][7] = obj.getStreet() == null ? "" : obj.getStreet();
                EBISystem.getCRMModule().getEBICRMCampaign().tabModReceiver.data[i][8] = obj.getZip() == null ? "" : obj.getZip();
                EBISystem.getCRMModule().getEBICRMCampaign().tabModReceiver.data[i][9] = obj.getLocation() == null ? "" : obj.getLocation();
                EBISystem.getCRMModule().getEBICRMCampaign().tabModReceiver.data[i][10] = obj.getPbox() == null ? "" : obj.getPbox();
                EBISystem.getCRMModule().getEBICRMCampaign().tabModReceiver.data[i][11] = obj.getCountry() == null ? "" : obj.getCountry();
                EBISystem.getCRMModule().getEBICRMCampaign().tabModReceiver.data[i][12] = obj.getEmail() == null ? "" : obj.getEmail();
                EBISystem.getCRMModule().getEBICRMCampaign().tabModReceiver.data[i][13] = obj.getReceiverid();
                i++;
            }
        } else {
            EBISystem.getCRMModule().getEBICRMCampaign().tabModReceiver.data = new Object[][]{{EBISystem.i18n("EBI_LANG_PLEASE_SELECT"), "", "", "", "", "", "", "", "", "", "", ""}};
        }
        EBISystem.getCRMModule().getEBICRMCampaign().tabModReceiver.fireTableDataChanged();
    }

    public void dataShowProduct() {
        if (this.campaign.getCrmcampaignpositions().size() > 0) {
            EBISystem.getCRMModule().getEBICRMCampaign().tabModProduct.data = new Object[this.campaign.getCrmcampaignpositions().size()][9];
            ...
            while (itr.hasNext()) {
                ...
                EBISystem.getCRMModule().getEBICRMCampaign().tabModProduct.data[i][0] = obj.getQuantity();
                EBISystem.getCRMModule().getEBICRMCampaign().tabModProduct.data[i][1] = obj.getProductnr();
                EBISystem.getCRMModule().getEBICRMCampaign().tabModProduct.data[i][2] = obj.getProductname() == null ? "" : obj.getProductname();
                EBISystem.getCRMModule().getEBICRMCampaign().tabModProduct.data[i][3] = obj.getCategory() == null ? "" : obj.getCategory();
                EBISystem.getCRMModule().getEBICRMCampaign().tabModProduct.data[i][4] = obj.getTaxtype() == null ? "" : obj.getTaxtype();
                EBISystem.getCRMModule().getEBICRMCampaign().tabModProduct.data[i][5] = currency.format(EBISystem.getCRMModule().dynMethod.calculatePreTaxPrice(obj.getNetamount(), String.valueOf(obj.getQuantity()), String.valueOf(obj.getDeduction()))) == null ? "" : currency.format(EBISystem.getCRMModule().dynMethod.calculatePreTaxPrice(obj.getNetamount(), String.valueOf(obj.getQuantity()), String.valueOf(obj.getDeduction())));
                EBISystem.getCRMModule().getEBICRMCampaign().tabModProduct.data[i][6] = obj.getDeduction().equals("") ? "" : obj.getDeduction() + "%";
                EBISystem.getCRMModule().getEBICRMCampaign().tabModProduct.data[i][7] = obj.getDescription() == null ? "" : obj.getDescription();
                EBISystem.getCRMModule().getEBICRMCampaign().tabModProduct.data[i][8] = obj.getPositionid();
                i++;
            }
        } else {
            EBISystem.getCRMModule().getEBICRMCampaign().tabModProduct.data = new Object[][]{{EBISystem.i18n("EBI_LANG_PLEASE_SELECT"), "", "", "", "", "", "", ""}};
        }
        EBISystem.getCRMModule().getEBICRMCampaign().tabModProduct.fireTableDataChanged();
    }
    ...
    private void createHistory(final Crmcampaign com) throws Exception {
        ...
        EBISystem.getCRMModule().hcreator.setDataToCreate(new EBICRMHistoryDataUtil(com.getCampaignid(), "CRMCampaign", list));
    }
    ...
    public void dataShowProperties() {
        if (this.campaign.getCrmcampaignprops().size() > 0) {
            EBISystem.getCRMModule().getEBICRMCampaign().tabModProperties.data = new Object[this.campaign.getCrmcampaignprops().size()][3];
            final Iterator iter = this.campaign.getCrmcampaignprops().iterator();
            int i = 0;
            while (iter.hasNext()) {
                final Crmcampaignprop dim = (Crmcampaignprop) iter.next();
                EBISystem.getCRMModule().getEBICRMCampaign().tabModProperties.data[i][0] = dim.getName() == null ? "" : dim.getName();
                EBISystem.getCRMModule().getEBICRMCampaign().tabModProperties.data[i][1] = dim.getValue() == null ? "" : dim.getValue();
                EBISystem.getCRMModule().getEBICRMCampaign().tabModProperties.data[i][2] = dim.getPropertiesid();
                i++;
            }
        } else {
            EBISystem.getCRMModule().getEBICRMCampaign().tabModProperties.data = new Object[][]{{EBISystem.i18n("EBI_LANG_PLEASE_SELECT"), "", ""}};
        }
        EBISystem.getCRMModule().getEBICRMCampaign().tabModProperties.fireTableDataChanged();
    }
    ...
    public void dataShowDoc() {
        if (this.campaign.getCrmcampaigndocses().size() > 0) {
            EBISystem.getCRMModule().getEBICRMCampaign().tabModDoc.data = new Object[this.campaign.getCrmcampaigndocses().size()][4];
            final Iterator itr = this.campaign.getCrmcampaigndocses().iterator();
            int i = 0;
            while (itr.hasNext()) {
                final Crmcampaigndocs obj = (Crmcampaigndocs) itr.next();
                EBISystem.getCRMModule().getEBICRMCampaign().tabModDoc.data[i][0] = obj.getName() == null ? "" : obj.getName();
                EBISystem.getCRMModule().getEBICRMCampaign().tabModDoc.data[i][1] = EBISystem.getInstance().getDateToString(obj.getCreateddate()) == null ? "" : EBISystem.getInstance().getDateToString(obj.getCreateddate());
                EBISystem.getCRMModule().getEBICRMCampaign().tabModDoc.data[i][2] = obj.getCreatedfrom() == null ? "" : obj.getCreatedfrom();
                EBISystem.getCRMModule().getEBICRMCampaign().tabModDoc.data[i][3] = obj.getDocid();
                i++;
            }
        } else {
            EBISystem.getCRMModule().getEBICRMCampaign().tabModDoc.data = new Object[][]{{EBISystem.i18n("EBI_LANG_PLEASE_SELECT"), "", ""}};
        }
        EBISystem.getCRMModule().getEBICRMCampaign().tabModDoc.fireTableDataChanged();
    }
