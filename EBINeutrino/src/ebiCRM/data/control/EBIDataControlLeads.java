...
public class EBIDataControlLeads {
		...
		try {
			...
			if (iter.hasNext()) {
				...
				while (cit.hasNext()) {
					...
					if (Integer.parseInt(EBISystem.getCRMModule().getLeadPane().tabModel.data[EBISystem.getCRMModule().getLeadPane().selectedRow][12].toString()) == contact.getContactid()) {
				...
				while (ait.hasNext()) {
					...
					if (Integer.parseInt(EBISystem.getCRMModule().getLeadPane().tabModel.data[EBISystem.getCRMModule().getLeadPane().selectedRow][13].toString()) == address.getAddressid()) {
						EBISystem.gui().label("addressLabel", "Leads").setText(address.getStreet() == null ? "" : address.getStreet());
	...
	public void dataShow() {
		...
		try {
			...
			if (set != null) {
				set.last();
				EBISystem.getCRMModule().getLeadPane().tabModel.data = new Object[set.getRow()][14];

				if (set.getRow() > 0) {
					set.beforeFirst();
					int i = 0;
					while (set.next()) {
						EBISystem.getCRMModule().getLeadPane().tabModel.data[i][0] = set.getString("COMPANY.NAME") == null ? "" : set.getString("COMPANY.NAME");
						EBISystem.getCRMModule().getLeadPane().tabModel.data[i][1] = set.getString("COMPANYCONTACTS.GENDER") == null ? "" : set.getString("COMPANYCONTACTS.GENDER");
						EBISystem.getCRMModule().getLeadPane().tabModel.data[i][2] = set.getString("COMPANYCONTACTS.POSITION") == null ? "" : set.getString("COMPANYCONTACTS.POSITION");
						EBISystem.getCRMModule().getLeadPane().tabModel.data[i][3] = set.getString("COMPANYCONTACTS.NAME") == null ? "" : set.getString("COMPANYCONTACTS.NAME");
						EBISystem.getCRMModule().getLeadPane().tabModel.data[i][4] = set.getString("COMPANYCONTACTS.SURNAME") == null ? "" : set.getString("COMPANYCONTACTS.SURNAME");
						...
						EBISystem.getCRMModule().getLeadPane().tabModel.data[i][5] = zipLoc;
						EBISystem.getCRMModule().getLeadPane().tabModel.data[i][6] = set.getString("COMPANYADDRESS.COUNTRY") == null ? "" : set.getString("COMPANYADDRESS.COUNTRY");
						EBISystem.getCRMModule().getLeadPane().tabModel.data[i][7] = set.getString("COMPANYCONTACTS.PHONE") == null ? "" : set.getString("COMPANYCONTACTS.PHONE");
						EBISystem.getCRMModule().getLeadPane().tabModel.data[i][8] = set.getString("COMPANYCONTACTS.MOBILE") == null ? "" : set.getString("COMPANYCONTACTS.MOBILE");
						EBISystem.getCRMModule().getLeadPane().tabModel.data[i][9] = set.getString("COMPANYCONTACTS.EMAIL") == null ? "" : set.getString("COMPANYCONTACTS.EMAIL");
						EBISystem.getCRMModule().getLeadPane().tabModel.data[i][10] = set.getString("COMPANY.QUALIFICATION") == null ? "" : set.getString("COMPANY.QUALIFICATION");
						EBISystem.getCRMModule().getLeadPane().tabModel.data[i][11] = set.getInt("COMPANY.COMPANYID") == 0 ? 0 : set.getInt("COMPANY.COMPANYID");
						EBISystem.getCRMModule().getLeadPane().tabModel.data[i][12] = set.getString("COMPANYCONTACTS.CONTACTID") == null ? "" : set.getString("COMPANYCONTACTS.CONTACTID");
						EBISystem.getCRMModule().getLeadPane().tabModel.data[i][13] = set.getString("COMPANYADDRESS.ADDRESSID") == null ? "" : set.getString("COMPANYADDRESS.ADDRESSID");
						i++;
					}
				} else {
					EBISystem.getCRMModule().getLeadPane().tabModel.data = new Object[][] {
			...
			EBISystem.getCRMModule().getLeadPane().tabModel.fireTableDataChanged();
			if(set != null){
				try {
					set.close();
					ps1.close();
		...
		try {
			...
			if (set != null) {
				...
				if (set.getRow() > 0) {
					...
					int i = 0;
					while (set.next()) {
						EBISystem.getCRMModule().getLeadPane().tabModel.data[i][0] = set
								.getString("COMPANY.NAME") == null ? "" : set.getString("COMPANY.NAME");
						EBISystem.getCRMModule().getLeadPane().tabModel.data[i][1] = set
								.getString("COMPANYCONTACTS.GENDER") == null ? ""
										: set.getString("COMPANYCONTACTS.GENDER");
						EBISystem.getCRMModule().getLeadPane().tabModel.data[i][2] = set
								.getString("COMPANYCONTACTS.POSITION") == null ? ""
										: set.getString("COMPANYCONTACTS.POSITION");
						EBISystem.getCRMModule().getLeadPane().tabModel.data[i][3] = set
								.getString("COMPANYCONTACTS.NAME") == null ? "" : set.getString("COMPANYCONTACTS.NAME");
						EBISystem.getCRMModule().getLeadPane().tabModel.data[i][4] = set
	...
	public void dataNew() {
		...
		address = new Companyaddress();
		isEdit = false;
		EBISystem.getCRMModule().getLeadPane().initialize();
