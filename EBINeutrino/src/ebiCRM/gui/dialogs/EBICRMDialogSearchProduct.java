...
public class EBICRMDialogSearchProduct {
    ...
    public void setVisible() {
        ...
        EBISystem.gui().combo("categoryText", "searchProduct").setModel(new DefaultComboBoxModel(EBICRMProduct.category));
    ...
    private void fillDipendencyList() {
        ...
        try {
            ...
            if (it.hasNext()) {
                ...
                dep.setDependencyid((EBISystem.getCRMModule().getEBICRMProductPane().dataControlProduct.getProduct().getCrmproductdependencies().size() +1) * -1);
                ...
                dipendency.add(dep);
                EBISystem.getCRMModule().getEBICRMProductPane().dataControlProduct.getProduct().getCrmproductdependencies().add(dep);
            }
