...
public class EBIDialogProperties {
    ...
    private void getAvalProjectCosts() {
        ...
        try {
            ps = EBISystem.getDatabase().initPreparedStatement("SELECT * FROM CRMPROJECTCOSTS order by NAME");
            set = ps.executeQuery();
    ...
    private void saveProductProperties() {
        ...
        dimension.setCrmproduct(EBISystem.getCRMModule().getEBICRMProductPane().dataControlProduct.getProduct());
        ...
        EBISystem.getCRMModule().getEBICRMProductPane().showDependency();
    ...
    private void saveCampaignProperties() {
        ...
        campaignProperties.setCrmcampaign(EBISystem.getCRMModule().getEBICRMCampaign().dataControlCampaign.getCampaign());
        ...
        EBISystem.getCRMModule().getEBICRMCampaign().showCampaignProperties();
    }
