...
public class EBIDialogTaxAdministration {
    ...
    public void setVisible() {
        ...
        EBISystem.gui().button("newBnt", "taxAdminDialog").setIcon(new ImageIcon(getClass().getClassLoader().getResource("new.png")));
        ...
        EBISystem.gui().button("editBnt", "taxAdminDialog").setIcon(new ImageIcon(getClass().getClassLoader().getResource("down.png")));
        ...
        EBISystem.gui().button("deleteBnt", "taxAdminDialog").setIcon(new ImageIcon(getClass().getClassLoader().getResource("delete.png")));
        ...
        EBISystem.gui().combo("taxCombo", "taxAdminDialog").setModel(new DefaultComboBoxModel(EBICRMProduct.taxType));
    ...
    private void setProductTax() {
        ...
        try {
            ...
            ps = EBISystem.getDatabase().initPreparedStatement("SELECT * FROM COMPANYPRODUCTTAXVALUE order by NAME");
            set = ps.executeQuery();
