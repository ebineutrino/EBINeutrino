...
public class EBICRMAccountStack {
    ...
    public EBIDataControlAccountStack dataControlAccount = new EBIDataControlAccountStack();;
    ...
    public void newCreditDebit(final int id) {
        ...
        EBISystem.gui().combo("taxTypeText", "creditDebitDialog").setModel(new DefaultComboBoxModel(EBICRMProduct.taxType));
    ...
    public void historyAccount(){
        new EBICRMHistoryView(EBISystem.getCRMModule().hcreator.retrieveDBHistory(Integer.parseInt(tabModAccount.data[selectedInvoiceRow][6].toString()), "Account")).setVisible();
    }
