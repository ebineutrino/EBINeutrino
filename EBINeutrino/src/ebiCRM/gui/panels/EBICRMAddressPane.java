...
public class EBICRMAddressPane {
    ...
    public EBIDataControlAddress addressDataControl = new EBIDataControlAddress();
    ...
    public void historyAddress() {
        new EBICRMHistoryView(EBISystem.getCRMModule().hcreator.retrieveDBHistory(EBISystem.getInstance().company.getCompanyid(), "Address")).setVisible();
    }
