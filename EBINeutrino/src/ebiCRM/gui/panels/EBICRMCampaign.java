...
public class EBICRMCampaign {
     ...
     */
    public EBICRMCampaign() {
        dataControlCampaign = new EBIDataControlCampaign();
    }
    ...
    public void historyCampaign() {
        new EBICRMHistoryView(
                ((EBICRMModule) EBISystem.getInstance().getIEBIModule()).hcreator.retrieveDBHistory(
    ...
    public void mailCampaign() {
        ...
        EBISystem.gui().combo("templateText", "sendEMailMessage").setModel(
                new DefaultComboBoxModel(EBISystem.getCRMModule().dynMethod.getEMailTemplateNames()));
                    ...
                    public void actionPerformed(final ActionEvent e) {
                        if (!EBISystem.i18n("EBI_LANG_PLEASE_SELECT")
                            ...
                            EBISystem.gui().getEditor("MessageAreaText", "sendEMailMessage")
                                    .setText(EBISystem.getCRMModule().dynMethod
