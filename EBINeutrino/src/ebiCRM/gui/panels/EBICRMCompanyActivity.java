...
public class EBICRMCompanyActivity implements ChangeListener {
    ...
    public EBIDataControlActivity dataControlActivity = new EBIDataControlActivity();
    ...
    public void initializeAction() {
        ...
        // ACTIVITY TABLE
        /*****************************************************************************/
        EBISystem.gui().table("tableActivity", "Activity").setDefaultRenderer(Object.class, new MyOwnCellRederer(false, true));
    ...
    public void historySearch() {
        new EBICRMHistoryView(EBISystem.getCRMModule().
                hcreator.retrieveDBHistory(EBISystem.getInstance().company.getCompanyid(), "Activities")).setVisible();
    }
