...
public class EBICRMContactPane {
    ...
    public EBIDataControlContact controlContact = new EBIDataControlContact();
    ...
    public void addContactAddress() {
        final EBIAddressSelectionDialog daddress =
                new EBIAddressSelectionDialog(EBISystem.getCRMModule().getAddressPane().addressDataControl.getAddressList(), controlContact.getCoaddressList());
        daddress.setVisible();
    }
    ...
    public void historyContact(){
        new EBICRMHistoryView(EBISystem.getCRMModule().
                hcreator.retrieveDBHistory(EBISystem.getInstance().company.getCompanyid(), "Contact")).setVisible();
    }
