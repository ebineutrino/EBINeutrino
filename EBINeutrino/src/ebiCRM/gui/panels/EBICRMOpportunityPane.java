...
public class EBICRMOpportunityPane {
    ...
    public EBIDataControlOpportunity dataOpportuniyControl = new EBIDataControlOpportunity();
    ;
    ...
    public void historyOpportunity(){
        new EBICRMHistoryView(((EBICRMModule) EBISystem.getInstance().getIEBIModule()).hcreator.retrieveDBHistory(EBISystem.getInstance().company.getCompanyid(), "Opportunity")).setVisible();
    }
