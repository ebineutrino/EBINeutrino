...
public class EBICRMOrder {
    ...
    public EBIDataControlOrder dataControlOrder = new EBIDataControlOrder();
    ...
    public void searchOffer(){
        final EBIOfferSelectionDialog dialog = new EBIOfferSelectionDialog(EBISystem.getCRMModule().getOfferPane().dataControlOffer.getOfferList());
        dialog.setVisible();
    ...
    public void showOffer(){
        if (!"".equals(EBISystem.gui().textField("orderOfferText", "Order").getText())) {
            ...
            EBISystem.getCRMModule().getOfferPane().editOfferRemote(Integer.parseInt(tabModOrder.data[selectedOrderRow][3].toString()));
        } else {
    ...
    public void historyOrder(){
        new EBICRMHistoryView(EBISystem.getCRMModule().hcreator.retrieveDBHistory(EBISystem.getInstance().company.getCompanyid(), "Order")).setVisible();
    }
