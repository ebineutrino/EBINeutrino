...
public class EBICRMService {
    ...
    public EBIDataControlService dataControlService = new EBIDataControlService();
    ...
    public void historyService() {
        new EBICRMHistoryView(EBISystem.getCRMModule().hcreator.retrieveDBHistory(EBISystem.getInstance().company.getCompanyid(), "Service")).setVisible();
    }
