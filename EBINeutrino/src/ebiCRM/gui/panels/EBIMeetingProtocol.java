...
public class EBIMeetingProtocol {
    public EBIDataControlMeetingProtocol dataMeetingControl = new EBIDataControlMeetingProtocol();
    ...
    public void historyMeeting(){
        new EBICRMHistoryView(EBISystem.getCRMModule().hcreator.retrieveDBHistory(EBISystem.getInstance().company.getCompanyid(), "Meeting")).setVisible();
    }
