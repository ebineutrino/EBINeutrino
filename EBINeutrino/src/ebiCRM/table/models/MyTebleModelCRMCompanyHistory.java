...
public class MyTebleModelCRMCompanyHistory extends DefaultTreeTableModel {
        ...
        public MyTebleModelCRMCompanyHistory(final TreeTableNode root) {
                this(root, false);
        }

        public MyTebleModelCRMCompanyHistory(final TreeTableNode root, final boolean asksAllowsChildren) {
                super(root);
