...
public class CRMSetting {
    ...
    public void setVisible() {
        ...
        EBISystem.gui().button("catBnt", "crmSettingDialog").setIcon(new ImageIcon(getClass().getClassLoader().getResource("lf_monitoring.png")));
        ...
        EBISystem.gui().button("coopBnt", "crmSettingDialog").setIcon(new ImageIcon(getClass().getClassLoader().getResource("lf_monitoring.png")));
        EBISystem.gui().button("coopBnt", "crmSettingDialog").addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(final ActionEvent e) {
                final EBIDialogValueSetter setCategory = new EBIDialogValueSetter("CompanyCooperation", EBISystem.i18n("EBI_LANG_C_CRM_COOPERATION_TYP"));
                setCategory.setVisible();

            }
        });

        EBISystem.gui().button("classBnt", "crmSettingDialog").setIcon(new ImageIcon(getClass().getClassLoader().getResource("lf_monitoring.png")));
        ...
        EBISystem.gui().button("addressTypeBnt", "crmSettingDialog").setIcon(new ImageIcon(getClass().getClassLoader().getResource("lf_monitoring.png")));
        ...
        EBISystem.gui().button("reportTypeBnt", "crmSettingDialog").setIcon(new ImageIcon(getClass().getClassLoader().getResource("lf_monitoring.png")));
        ...
        EBISystem.gui().button("bussTypeBnt", "crmSettingDialog").setIcon(new ImageIcon(getClass().getClassLoader().getResource("lf_monitoring.png")));
        ...
        EBISystem.gui().button("saleStgBnt", "crmSettingDialog").setIcon(new ImageIcon(getClass().getClassLoader().getResource("lf_monitoring.png")));
        ...
        EBISystem.gui().button("budTypeBnt", "crmSettingDialog").setIcon(new ImageIcon(getClass().getClassLoader().getResource("lf_monitoring.png")));
        ...
        EBISystem.gui().button("evalTypeBnt", "crmSettingDialog").setIcon(new ImageIcon(getClass().getClassLoader().getResource("lf_monitoring.png")));
        ...
        EBISystem.gui().button("oppstatusBnt", "crmSettingDialog").setIcon(new ImageIcon(getClass().getClassLoader().getResource("lf_monitoring.png")));
        ...
        EBISystem.gui().button("activityStatusBnt", "crmSettingDialog").setIcon(new ImageIcon(getClass().getClassLoader().getResource("lf_monitoring.png")));
        ...
        EBISystem.gui().button("activityTypeBnt", "crmSettingDialog").setIcon(new ImageIcon(getClass().getClassLoader().getResource("lf_monitoring.png")));
        ...
        EBISystem.gui().button("offerStatusBnt", "crmSettingDialog").setIcon(new ImageIcon(getClass().getClassLoader().getResource("lf_monitoring.png")));
        ...
        EBISystem.gui().button("orderStatusBnt", "crmSettingDialog").setIcon(new ImageIcon(getClass().getClassLoader().getResource("lf_monitoring.png")));
        ...
        EBISystem.gui().button("productCatBnt", "crmSettingDialog").setIcon(new ImageIcon(getClass().getClassLoader().getResource("lf_monitoring.png")));
        ...
        EBISystem.gui().button("productTypeBnt", "crmSettingDialog").setIcon(new ImageIcon(getClass().getClassLoader().getResource("lf_monitoring.png")));
        ...
        EBISystem.gui().button("productPropBnt", "crmSettingDialog").setIcon(new ImageIcon(getClass().getClassLoader().getResource("lf_monitoring.png")));
        ...
        EBISystem.gui().button("productTaxBnt", "crmSettingDialog").setIcon(new ImageIcon(getClass().getClassLoader().getResource("lf_monitoring.png")));
        ...
        EBISystem.gui().button("campaignStatusBnt", "crmSettingDialog").setIcon(new ImageIcon(getClass().getClassLoader().getResource("lf_monitoring.png")));
        ...
        EBISystem.gui().button("campaignTypeBnt", "crmSettingDialog").setIcon(new ImageIcon(getClass().getClassLoader().getResource("lf_monitoring.png")));
        ...
        EBISystem.gui().button("serviceStatusBnt", "crmSettingDialog").setIcon(new ImageIcon(getClass().getClassLoader().getResource("lf_monitoring.png")));
        ...
        EBISystem.gui().button("serviceTypeBnt", "crmSettingDialog").setIcon(new ImageIcon(getClass().getClassLoader().getResource("lf_monitoring.png")));
        ...
        EBISystem.gui().button("serviceCatBnt", "crmSettingDialog").setIcon(new ImageIcon(getClass().getClassLoader().getResource("lf_monitoring.png")));
        ...
        EBISystem.gui().button("prosolStatusBnt", "crmSettingDialog").setIcon(new ImageIcon(getClass().getClassLoader().getResource("lf_monitoring.png")));
        ...
        EBISystem.gui().button("prosolTypeBnt", "crmSettingDialog").setIcon(new ImageIcon(getClass().getClassLoader().getResource("lf_monitoring.png")));
        ...
        EBISystem.gui().button("prosolCateBnt", "crmSettingDialog").setIcon(new ImageIcon(getClass().getClassLoader().getResource("lf_monitoring.png")));
        ...
        EBISystem.gui().button("prosolClassBnt", "crmSettingDialog").setIcon(new ImageIcon(getClass().getClassLoader().getResource("lf_monitoring.png")));
        ...
        EBISystem.gui().button("prjStatusBnt", "crmSettingDialog").setIcon(new ImageIcon(getClass().getClassLoader().getResource("lf_monitoring.png")));
        ...
        EBISystem.gui().button("taskStatusBnt", "crmSettingDialog").setIcon(new ImageIcon(getClass().getClassLoader().getResource("lf_monitoring.png")));
        ...
        EBISystem.gui().button("taskTypeBnt", "crmSettingDialog").setIcon(new ImageIcon(getClass().getClassLoader().getResource("lf_monitoring.png")));
        ...
        EBISystem.gui().button("costPropBnt", "crmSettingDialog").setIcon(new ImageIcon(getClass().getClassLoader().getResource("lf_monitoring.png")));
        ...
        EBISystem.gui().button("taskPropBnt", "crmSettingDialog").setIcon(new ImageIcon(getClass().getClassLoader().getResource("lf_monitoring.png")));
        ...
        EBISystem.gui().button("invoiceStsBnt", "crmSettingDialog").setIcon(new ImageIcon(getClass().getClassLoader().getResource("lf_monitoring.png")));
        ...
        EBISystem.gui().button("invoiceCatBnt", "crmSettingDialog").setIcon(new ImageIcon(getClass().getClassLoader().getResource("lf_monitoring.png")));
    ...
    public void refreshingCombo() {
        final Runnable runnable = new Runnable() {
            @Override
            public void run() {
                EBISystem.getCRMModule().dynMethod.initComboBoxes(true);
            }
        };
