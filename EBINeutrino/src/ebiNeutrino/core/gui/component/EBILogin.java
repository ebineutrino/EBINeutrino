...
public class EBILogin extends JFrame {
    ...
    private JPanel getJPanelControl() {
        if (jPanelControl == null) {
            ...
            jLabel4.setIcon(new ImageIcon(getClass().getClassLoader().getResource("password.png")));
            jLabel4.setText("");
            final JLabel jLabel3=new JLabel();
            jLabel3.setBounds(new java.awt.Rectangle(404, 75, 25, 27));
            jLabel3.setIcon(new ImageIcon(getClass().getClassLoader().getResource("contact.png")));
            jLabel3.setText("");
