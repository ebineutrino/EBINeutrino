...
public class EBISetupDB extends JPanel {
    ...
    public void paintComponent(final Graphics g) {
        ...
        g2.drawImage(new ImageIcon(getClass().getClassLoader().getResource("theader.gif")).getImage(), 0, 0, null);
    ...
    private JButton getJButtonGenerating() {
        if (jButtonGenerating == null) {
            ...
            jButtonGenerating.setIcon(new ImageIcon(getClass().getResource("button_ok.png")));
    ...
    private JButton getJButtonOK() {
        if (jButtonOK == null) {
            ...
            jButtonOK.setIcon(new ImageIcon(getClass().getResource("/Icon/button_ok.png")));
    ...
    private JButton getJButtonCancel() {
        if (jButtonCancel == null) {
            ...
            jButtonCancel.setIcon(new ImageIcon(getClass().getResource("/Icon/button_cancel.png")));
