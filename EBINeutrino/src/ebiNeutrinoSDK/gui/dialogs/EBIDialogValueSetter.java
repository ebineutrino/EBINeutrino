...
public class EBIDialogValueSetter {
    ...
    public void setVisible() {
        ...
        EBISystem.gui().button("newBnt", "valueSetterDialog").setIcon(new ImageIcon(getClass().getClassLoader().getResource("new.png")));
        ...
        EBISystem.gui().button("editBnt", "valueSetterDialog").setIcon(new ImageIcon(getClass().getClassLoader().getResource("down.png")));
        ...
        EBISystem.gui().button("deleteBnt", "valueSetterDialog").setIcon(new ImageIcon(getClass().getClassLoader().getResource("delete.png")));
