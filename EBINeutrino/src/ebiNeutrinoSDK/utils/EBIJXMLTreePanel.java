...
public class EBIJXMLTreePanel extends JTree {
    ...
    private void initialize() {
        ...
        final ImageIcon tutorialIcon = new ImageIcon(getClass().getClassLoader().getResource("agt_action_success.png"));
        final ImageIcon errorIcon = new ImageIcon(getClass().getClassLoader().getResource("agt_action_fail.png"));
