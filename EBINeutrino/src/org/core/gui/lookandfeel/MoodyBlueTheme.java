...
public class MoodyBlueTheme extends DefaultMetalTheme {
	...
	public static final Color editorForeground = new Color(255,255,255);
	...
	public MoodyBlueTheme() {
		...
		UIManager.put("TabbedPane.tabAreaBackground",  new Color(41, 47, 54));
		UIManager.put("TabbedPane.tabAreaInsets", insets);
		UIManager.put("TabbedPane.tabAreaBackground",  new Color(41, 47, 54));UIManager.put("ScrollBar.border",   BorderFactory.createMatteBorder(1, 1, 1, 1, new Color(45, 45, 45)));
