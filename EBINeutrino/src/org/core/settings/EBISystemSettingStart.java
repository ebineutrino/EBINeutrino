...
import org.modules.views.dialogs.EBIExportDialog;
import org.modules.views.dialogs.EBIImportDialog;
...
public class EBISystemSettingStart extends JPanel {
    ...
    private void initialize() {
        ...
        jLabel1.setIcon(EBISystem.getInstance().getIconResource("advancedsettings.png"));
