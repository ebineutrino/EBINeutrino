...
public class ModelCRMContact extends AbstractTableModel {
    ...
    @Getter
    @Setter
    public List<Companycontacts> availableContacts;
    
    @Getter
    @Setter
    public List<Companyopportunitycontact> availableOpportunityContacts;
    
    @Getter
    @Setter
    public List<Companymeetingcontacts> availableMeetingContacts;
