...
public class EBIOpportunitySelectionDialog {
    ...
    public void setVisible() {
        EBISystem.builder().dialog("abstractSelectionDialog").setTitle(EBISystem.i18n("EBI_LANG_C_OPPORTUNITY_LIST"));
        EBISystem.builder().vpanel("abstractSelectionDialog").setModuleTitle(EBISystem.i18n("EBI_LANG_C_OPPORTUNITY_LIST"));
    ...
    private void showCollectionList() {
        if (this.opList.size() > 0) {
            ...
            while (itr.hasNext()) {
                ...
                tabModel.data[i][6] = obj.getClosedate() == null ? "" : EBISystem.getInstance().getDateToString(obj.getClosedate());
